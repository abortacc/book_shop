...
urlpatterns = [
    ...
    path('<slug:username>/wishlist/', views.WishlistListView.as_view(), name='wishlist'),
    path('wishlist/add/<int:book_id>/', views.AddToWishlistView.as_view(), name='add_to_wishlist'),
    path('wishlist/remove/<int:book_id>/', views.RemoveFromWishlistView.as_view(), name='remove_from_wishlist'),
]
